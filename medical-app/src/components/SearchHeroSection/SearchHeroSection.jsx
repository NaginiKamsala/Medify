...
const SearchHeroSection = ({ setResultsList, setCityName, resultsList }) => {
  ...
  if (path === "/bookings") {
    return (
      <div
        className={` ${styles.search_section_bookings} 
  ...
  return (
    <div
      className={` ${styles.search_section_wrapper} 
            ${
              path === "/"
                ? styles.search_section_postion_home
                : styles.search_section_postion_other_pages
            } 
            `}
    >
